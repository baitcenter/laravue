<template>
  <div class="app-container">
    <div class="description">Laravue provides two directives <el-tag class="permission-tag" size="small">v-role</el-tag> and <el-tag class="permission-tag" size="small">v-permission</el-tag>. Please see the belw example here for details</div>
    ...
    <div :key="key" style="margin-top:30px;">
      <div>
        ...
        <el-tag v-role="['admin']" class="permission-sourceCode" type="info">v-role="['admin']"</el-tag>
      </div>
      <div>
        ...
        <el-tag v-role="['manager']" class="permission-sourceCode" type="info">v-role="['manager']"</el-tag>
      </div>
      <div>
        ...
        <el-tag v-role="['editor']" class="permission-sourceCode" type="info">v-role="['editor']"</el-tag>
      </div>
      <div>
        ...
        <el-tag v-role="['user']" class="permission-sourceCode" type="info">v-role="['user']"</el-tag>
      </div>
      <div>
        ...
        <el-tag v-role="['visitor']" class="permission-sourceCode" type="info">v-role="['visitor']"</el-tag>
      </div>
      ...
      <div>
        ...
        <el-tag v-role="['admin','editor']" class="permission-sourceCode" type="info">v-role="['admin','editor']"</el-tag>
      </div>
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        <el-tab-pane v-if="checkRole(['admin'])" label="Admin">
          Admin can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['admin'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkRole(['manager'])" label="Manager">
          Manager can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['manager'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkRole(['editor'])" label="Editor">
          Editor can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['editor'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkRole(['user'])" label="User">
          User can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['user'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkRole(['visitor'])" label="Visitor">
          Visitor can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['visitor'])"</el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkRole(['admin','editor'])" label="Admin-OR-Editor">
          Both admin or editor can see this
          <el-tag class="permission-sourceCode" type="info">v-if="checkRole(['admin','editor'])"</el-tag>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
